...
?></center>
  ...
  ?>
            <tr>
              ...
              <td>
                <a href="proses.php?hapus=<?php echo $d['id_mahasiswa']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')">
                    <i class="fa fa-trash"></i>
                </a>
                <a href="kelola.php?ubah=<?php echo $d['id_mahasiswa']; ?>" type="button" class="btn btn-success btn-sm">
