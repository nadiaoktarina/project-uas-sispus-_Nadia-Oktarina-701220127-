...
<div class="container-fluid">
      ...
      <a href="kelola4.php" type="button" class="btn btn-primary mb-3">
...
?></center>
  ...
  ?>
            <tr>
              ...
              <td>
                <a href="proses4.php?hapus=<?php echo $d['id_denda']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')">
                    <i class="fa fa-trash"></i>
                </a>
                <a href="kelola4.php?ubah=<?php echo $d['id_denda']; ?>" type="button" class="btn btn-success btn-sm">
